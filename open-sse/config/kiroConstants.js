 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what voidRoute needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a voidRoute
...
/**
 * Detect whether a model id refers to a voidRoute synthetic agentic variant.
...
/**
 * Detect whether a model id is a voidRoute synthetic thinking variant
...
/**
 * Resolve a voidRoute model id to the real upstream Kiro model id, plus flags
