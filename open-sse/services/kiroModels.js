 ...
 * into voidRoute-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are voidRoute fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic voidRoute variant set for a single upstream Kiro model.
 *
 ...
 * into voidRoute variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
